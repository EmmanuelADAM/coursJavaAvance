        ...
        for (int i = 0; i < nb - 1; i++) {
            ...
            for (int j = i + 1; j < nb; j++) {
                ...
                if (start.existeChemin(end)) {
                    ...
                    addTrajetSimple(new TrajetSimple(start, end, m, LocalTime.of(5, 0)));
                    addTrajetSimple(new TrajetSimple(end, start, m, LocalTime.of(5, 0)));
                    //TODO: ajouter les trajet entre 5:00 et 22:00
                }
            }
        }
    }
